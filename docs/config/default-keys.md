...
When using `disable_default_key_bindings`, it is recommended that you assign [ShowDebugOverlay](lua/keyassignment/ShowDebugOverlay.md) and [ActivateCommandPalette](lua/keyassignment/ActivateCommandPalette.md) to custom shortcuts for troubleshooting.
