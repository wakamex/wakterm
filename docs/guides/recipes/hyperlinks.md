...
Check the [mouse bindings](../configuration/mouse.md) section for examples on modifying the `OpenLinkAtMouseCursor` action.
...
(see [bypass mouse reporting modifiers](../../reference/config/bypass_mouse_reporting_modifiers.md)), add `Shift` when clicking an hyperlink.
