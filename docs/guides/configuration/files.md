...
- [wakterm.config_builder](../../reference/lua/wakterm/config_builder.md)
...
[window:set_config_overrides](../../reference/lua/window/set_config_overrides.md) documentation
...
adjusted settings, or visit the [Lua Config Reference](../../reference/config/index.md) for a more detailed list of possibilities.
