...
assignments](../../reference/lua/keyassignment/index.md).  Every action has an example that shows
how to use it.
...
[`enable_kitty_keyboard`](../../reference/config/enable_kitty_keyboard.md) is enabled.
