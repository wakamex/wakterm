...
[wakterm.gui.get_appearance()](../../reference/lua/wakterm.gui/get_appearance.md)
...
you need to use [wakterm.color.get_default_colors()](../../reference/lua/wakterm.color/get_default_colors.md) and explicitly merge them.
...
See also [wakterm.get_builtin_color_schemes()](../../reference/lua/wakterm/get_builtin_color_schemes.md) for
...
- [agent_tab_badge_mode](../../reference/config/agent_tab_badge_mode.md): controls whether indicators appear always (`"identity"`, default), on attention (`"attention"`), during active turn (`"turn"`), or never (`"off"`).
- [agent_tab_attention_pulse](../../reference/config/agent_tab_attention_pulse.md): when true (default), the harness icon pulses with a smooth fade when an agent has completed a turn and is awaiting user review. Set to false for a static attention dot.
- [agent_tab_badge](../../reference/config/agent_tab_badge.md): fallback text prefix used when no dedicated harness icon exists (default `"🤖 "`).
...
- [tab_bar_color_mode](../../reference/config/tab_bar_color_mode.md): `"Off"` (default), `"Hash"` (hash tab identity to color), or `"Assign"` (persist distinct colors across sessions).
- [tab_bar_color_palette](../../reference/config/tab_bar_color_palette.md): `"Dark"` (default), `"Light"`, or `"Mixed"`.
- [tab_bar_color_intensity](../../reference/config/tab_bar_color_intensity.md): adjust dimming multipliers for active, hover, and inactive states.
