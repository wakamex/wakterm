...
* The [`SpawnCommandInNewTab`](../../reference/lua/keyassignment/SpawnCommandInNewTab.md),
  and [`SpawnCommandInNewWindow`](../../reference/lua/keyassignment/SpawnCommandInNewWindow.md)
  key assignments, and the [Launcher Menu](#the-launcher-menu) described below
  all accept a [`SpawnCommand`](../../reference/lua/SpawnCommand.md) object that accepts an
  optional `cwd` field:
...
bind a key to the [ShowLauncher](../../reference/lua/keyassignment/ShowLauncher.md) or
[ShowLauncherArgs](../../reference/lua/keyassignment/ShowLauncherArgs.md) action to trigger the
menu.
...
[SpawnCommand](../../reference/lua/SpawnCommand.md) object.
