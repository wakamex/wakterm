...
* `"Hold"` - keep the pane open after the program exits. The pane must be manually closed via [CloseCurrentPane](../lua/keyassignment/CloseCurrentPane.md), [CloseCurrentTab](../lua/keyassignment/CloseCurrentTab.md) or closing the window.
