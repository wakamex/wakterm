...
You can use the [wakterm.gui.enumerate_gpus()](../lua/wakterm.gui/enumerate_gpus.md) function
to return a list of GPUs.

If you open the [Debug Overlay](../lua/keyassignment/ShowDebugOverlay.md) (default:
