...
See also
[skip_close_confirmation_for_processes_named](skip_close_confirmation_for_processes_named.md).
...
[CloseCurrentTab](../lua/keyassignment/CloseCurrentTab.md) documentation.
