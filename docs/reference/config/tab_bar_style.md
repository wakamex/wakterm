...
[format-tab-title](../lua/window-events/format-tab-title.md) event.

This config option allows styling the elements that appear in the tab bar.
This configuration supplements the [tab bar color](../../guides/configuration/appearance.md#tab-bar-appearance-colors)
options.
...
by the [wakterm.format](../lua/wakterm/format.md) function.
