...
in more detail in the [Fonts](../../guides/configuration/fonts.md) section.

If not specified, the font is same as the font in `window_frame.font`

You will typically use [wakterm.font](../lua/wakterm/font.md) or
[wakterm.font_with_fallback](../lua/wakterm/font_with_fallback.md) to specify the
font.
