...
[window_background_opacity](../../guides/configuration/appearance.md#window-background-opacity) is set
to less than `1.0`.
...
yourself via the [StartWindowDrag](../lua/keyassignment/StartWindowDrag.md) key
