...
* *label* - optional. Can be either a string to serve as a label in the
  [Launcher Menu](../../guides/configuration/launch.md#the-launcher-menu), or a lua function that will
  return the label.
...
The label is visible in the [Launcher Menu](../../guides/configuration/launch.md#the-launcher-menu).
