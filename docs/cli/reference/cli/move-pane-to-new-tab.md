...
See also: [pane:move_to_new_window()](../../../reference/lua/pane/move_to_new_window.md),
[pane:move_to_new_tab()](../../../reference/lua/pane/move_to_new_tab.md).

## Synopsis

```console
{% include "../../../generated/cli-help/cmd-synopsis-wakterm-cli-move-pane-to-new-tab--help.txt" %}
```
