...
- [Agent API v1 Contract](../agent-api/v1/README.md)
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-start--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-launch-codex--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-list--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-watch--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-inspect--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-adopt--help.txt" %}
```

```console
{% include "../examples/cmd-synopsis-wakterm-agent-adopt-detected--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-send--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-admit--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-request--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-request-get--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-request-watch--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-request-cancel--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-events--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-capabilities--help.txt" %}
```

```console
{% include "../examples/cmd-synopsis-wakterm-agent-catalog--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-interrupt--help.txt" %}
```
...
```console
{% include "../examples/cmd-synopsis-wakterm-agent-set--help.txt" %}
```

```console
{% include "../examples/cmd-synopsis-wakterm-agent-clear--help.txt" %}
```
